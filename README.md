...
- [SQL - задачи. Анализ базы данных сервиса по чтению книг](https://github.com/LizaVet23/Data_analyst/tree/main/SQL%20-%20задачи)  
   
  
**Задача:**  
  
Провести анализ базы данных сервиса по чтению книг.


**Инструменты и навыки:** `Python` `Pandas` `SQL` `PostgreSQL`
